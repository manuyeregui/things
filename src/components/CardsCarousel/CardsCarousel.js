  ...
  return (
    <FullscreenBox>
      ...
      <div>
        ...
        >
          <div
            className={`h-full w-10 flex justify-center items-center transition-all
                            ${
                              prev
                                ? "cursor-pointer"
          ...
          >
            <i className="border-l-3 border-t-3 w-5 h-5 rounded-sm -rotate-45" />
          </div>
          ...
          <div
            className={`h-full w-10 flex justify-center items-center transition-all ${
              next ? "cursor-pointer" : "pointer-events-none opacity-20"
            }`}
            onClick={() => next && setIndex(index + 1)}
          >
            <i className="border-r-3 border-t-3 w-5 h-5 rounded-sm rotate-45" />
          </div>
        </motion.div>
